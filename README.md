...
# 网腾无限 AI - 网腾无限AI - 教师教学与教研反思专家

**[基于 Vue 3 + Vite + Vanilla CSS 构建的 网腾无限AI - 教师教学与教研反思专家 智能实战微应用，具备深色玻璃拟态自适应交互与微信端 H5 体验]**

[Vue 3] · [TypeScript] · [Vite] · [Vanilla CSS] · [开源协议 MIT]

[![GitHub stars](https://img.shields.io/github/stars/WT-Agent/ai-jiaoshi?style=social)](https://github.com/WT-Agent/ai-jiaoshi)
[![GitHub license](https://img.shields.io/github/license/WT-Agent/ai-jiaoshi)](https://github.com/WT-Agent/ai-jiaoshi/blob/main/LICENSE)
[![Online Demo](https://img.shields.io/badge/Online_Demo-jiaoshi.wuxian.xyz-indigo?style=flat-square)](https://jiaoshi.wuxian.xyz)

[在线演示](https://jiaoshi.wuxian.xyz) · [快速启动](#快速启动) · [核心特性](#核心特性) · [脚手架集成](#脚手架集成说明) · [支持一下](#联系我们与打赏支持)
...
**网腾无限AI - 教师教学与教研反思专家** 专注于“**教师教学与教研反思专家**”。我们剔除了冗余概念，不搞虚假宣传，只提供极致优雅、即调即用的高完成度微应用前端与边缘网关接口。
...
1. **智能 Prompt 场景引擎**：针对 **教师教学与教研反思专家** 领域进行了深度提示词工程优化与共识打分约束。
...
### 1. 克隆项目
```bash
git clone https://github.com/WT-Agent/ai-jiaoshi.git
cd ai-jiaoshi
```
...
```bash
# 自动化发版与发布
node bin/cli.js publish ai-jiaoshi

# 查看当前微应用配置
node bin/cli.js get ai-jiaoshi

# 动态热更新提示词或模型映射
node bin/cli.js set ai-jiaoshi prompt "教师教学与教研反思专家"
node bin/cli.js set ai-jiaoshi model deepseek-chat
```
...
- **官方网站**: [https://jiaoshi.wuxian.xyz](https://jiaoshi.wuxian.xyz)
- **GitHub Issues**: [提交反馈](https://github.com/WT-Agent/ai-jiaoshi/issues)
- **反馈邮箱**: us@wuxian.xyz
